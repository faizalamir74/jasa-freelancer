                ...
                <main class="p-4 lg:col-span-7 md:col-span-12 md:pt-0">
                    <div class="sm:grid sm:h-32 sm:grid-flow-row sm:gap-4 sm:grid-cols-3">
                        <div class="flex flex-col justify-center px-4 py-4 mb-4 bg-white rounded-xl">
                            <div>
                                ...
                                <p class="mt-2 text-2xl font-semibold text-left text-gray-800">{{ $progress ?? '0' }}</p>
                        ...
                        <div class="flex flex-col justify-center px-4 py-4 mb-4 bg-white rounded-xl">
                            <div>
                                ...
                                <p class="mt-2 text-2xl font-semibold text-left text-gray-800">{{ $completed ?? '0' }}</p>
                                <p class="text-sm text-left text-gray-500">
                                    Services <br class="hidden lg:block">
                                    Completed
                                </p>
                        ...
                        <div class="flex flex-col justify-center px-4 py-4 mb-4 bg-white rounded-xl">
                            <div>
                                ...
                                <p class="mt-2 text-2xl font-semibold text-left text-gray-800">{{ $freelancer ?? '0' }}</p>
                                <p class="text-sm text-left text-gray-500">
                    ...
                    <div class="p-6 mt-8 bg-white rounded-xl">
                        <div>
                            ...
                            <p class="text-sm text-gray-400">
                                {{ $progress ?? '0' }} Total Orders On Progress
                            </p>
                        </div>
                                            ...
                                            <div class="flex items-center text-sm">
                                                <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                    ...
                                                    @if ($item->user_buyer->detail_user->photo != NULL)
                                                        ...
                                                        class="object-cover inline w-12 h-12 mr-3 rounded-full">
                                                    @else
                                        ...
                                        <td class="w-2/4 px-1 py-5">
                                            <div class="flex items-center text-sm">
                                                <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                    ...
                                                    @else
                                                        <svg class="object-cover w-full h-full text-gray-300" fill="currentColor" viewBox="0 0 24 24">
                                                            <path d="M24 20.993V24H0v-2.996A14.977 14.977 0 0112.004 15c4.904 0 9.26 2.354 11.996 5.993zM16.002 8.999a4 4 0 11-8 0 4 4 0 018 0z" />
                                                        </svg>
                                                    @endif
                                                    <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
