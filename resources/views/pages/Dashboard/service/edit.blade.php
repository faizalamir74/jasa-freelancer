                        ...
                        <form action="{{ route('member.service.update', [$service->id]) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="">
                                <div class="px-4 py-5 sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Service apa yang ingin kamu tawarkan?" type="text" required
                                            name="title" id="title" autocomplete="title" value="{{ $service->title ?? '' }}"
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Jelaskan Service apa yang kamu tawarkan?" type="text" required
                                            name="description" id="description" autocomplete="description" value="{{ $service->description ?? '' }}"
                                            class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            @forelse ($advantage_service as $advantage_item)
                                                <input placeholder="Keunggulan 1" type="text" name="{{ ('advantage-services['.$advantage_item->id.']') }}" 
                                                value="{{ $advantage_item->advantage ?? '' }}" required id="advantage-services" autocomplete="advantage-services" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                            @empty
                                                {{-- empty --}}
                                            @endforelse
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            <select id="revision_limit" name="revision_limit" autocomplete="revision_limit" class="block w-full px-3 py-3 pr-10 mt-1 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                                <option>Maksimal Revisi service kamu</option>
                                                <option value="1" {{ $service->revision_limit == '1' ? 'selected' : '' }}>1 Kali Revisi</option>
                                                <option value="2" {{ $service->revision_limit == '2' ? 'selected' : '' }}>2 Kali Revisi</option>
                                                <option value="3" {{ $service->revision_limit == '3' ? 'selected' : '' }}>3 Kali Revisi</option>
                                            </select>
                                        </div>

                                        <div class="col-span-6">
                                            <label for="price" class="block mb-3 font-medium text-gray-700 text-md">Harga Service Kamu</label>
                                            <input placeholder="Total Harga Service Kamu" type="number" name="price" value="{{ $service->price ?? '' }}" required id="price" autocomplete="price" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                            @if ($errors->has('price'))
                                            ...
                                            <div class="grid grid-cols lg:grid-cols-3 md:grid-cols-2 gap-4">
                                                @forelse ($thumbnail_service as $thumbnail_item)
                                                    <div class="mb-2">
                                                        ...
                                                        alt="thumbnail" class="inline object-cover w-20 h-20 rounded" for="choose">
                                                        <input placeholder="Thumbnail" type="file" name="{{ 'thumbnails['.$thumbnail_item->id.']' }}"
                                                        id="thumbnails" autocomplete="thumbnails" class="block w-full py-3 pl-5 mt-3 border-gray-300 rounded-md shadow-sm focus:ring-green-500 sm:text-sm">
                                                    </div>
                                                @empty
                                                    {{-- empty --}}
                                                @endforelse
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            @forelse ($advantage_user as $advantage_user_item)
                                                <input placeholder="Keunggulan 1" type="text" name="{{ ('advantage-users['.$advantage_user_item->id.']') }}" 
                                                value="{{ $advantage_user_item->advantage ?? '' }}" required id="advantage-users" autocomplete="advantage-users" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                            @empty
                                                {{-- empty --}}
                                            @endforelse<div id="newAdvantagesRow"></div>
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Hal yang ingin disampaikan oleh kamu?" type="text" name="note" id="note" autocomplete="note" value="{{ $service->note ?? '' }}" required class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                            @if ($errors->has('note'))
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            @forelse ($tagline as $tagline_item)
                                                ...
                                                value="{{ $tagline_item->tagline ?? '' }}" required id="taglines" autocomplete="taglines" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                            @empty
                                                {{-- empty --}}
                                            @endforelse
                                ...
                                <div class="px-4 py-3 text-right sm:px-6">
                                    <a href="{{ route('member.service.index') }}" onclick="return confirm('Are you sure ? any changes you make will not be saved')" type="button" class="inline-flex justify-center px-4 py-2 mr-4 text-sm font-medium text-gray-700 bg-white border border-gray-600 rounded-lg shadow-sm hover:bg-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300">
                                        Cancel
                                    </a>
                                    <button type="submit" onclick="return confirm('Are you sure want to update your data ?')" class="inline-flex justify-center px-4 py-2 text-sm font-medium text-white bg-green-600 border border-transparent rounded-lg shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                                        Save Changes
                                    </button>
                                </div>
                            </div>
...
@push('after-script')
    ...
    <script type="text/javascript">
        ...
        $("#addAdvantagesRow").click(function() {
            var html = '';
            html += '<input placeholder="Keunggulan" type="text" name="advantage-user[]" id="advantage-user" autocomplete="advantage-user" required class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">';
    ...
    <script type="text/javascript">
        ...
        $("#addServicesRow").click(function() {
            var html = '';
            html += '<input placeholder="Keunggulan" type="text" name="advantage-service[]" id="advantage-service" required autocomplete="advantage-service" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">';
    ...
    <script type="text/javascript">
        ...
        $("#addTaglineRow").click(function() {
            var html = '';
            html += '<input placeholder="Keunggulan" type="text" name="tagline[]" id="tagline" required autocomplete="tagline" required class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">';
    ...
    <script type="text/javascript">
        ...
        $("#addThumbnailRow").click(function() {
            var html = '';
            html += '<input placeholder="Keunggulan 3" type="file" name="thumbnail[]" required id="thumbnail" autocomplete="thumbnail" class="block w-full py-3 pl-5 mt-1 border border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">';
