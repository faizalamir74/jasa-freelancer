                                            ...
                                            <div class="flex items-center text-sm">
                                                <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                    @if ($order->user_buyer->detail_user->photo != NULL)
                                                        ...
                                                        src="{{ url(Storage::url($order->user_buyer->detail_user->photo)) }}" alt="" loading="lazy" />
                                                    @else
                                        ...
                                        <td class="px-1 py-5 text-sm">
                                            @if ($order->order_status_id == '1')
                                                <a href="{{ route('member.order.show', $order->id) }}" 
                                                    ...
                                                    Details</a>
                                                <a class="px-4 py-2 mt-2 text-center text-white rounded-xl bg-green-600">
                                                    Approved
                                                </a>
                                            ...
                                            @elseif ($order->order_status_id == '3')
                                                <a href="{{ route('member.order.show', $order->id) }}" 
                                                    class="px-4 py-2 mt-1 mr-2 text-center text-white rounded-xl bg-serv-email">
                                                    Details</a>
                                                <a class="px-4 py-2 mt-2 text-center text-white rounded-xl bg-red-400">
                                                    Rejected
                                                </a>
    ...
    @else
        <div class="flex h-screen">
            <div class="m-auto text-center">
                ...
                <p class="text-sm text-gray-400">
                It seems that someone haven’t ordered your service yet. <br>
                Don't be discouraged because you haven't got any order!
                </p>
