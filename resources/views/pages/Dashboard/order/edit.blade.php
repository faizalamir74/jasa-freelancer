                                    ...
                                    <td class="px-1 py-5 text-sm w-2/8">
                                        <div class="flex items-center text-sm">
                                            <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                ...
                                                @endif<div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                                            </div>
                                            <div>
                        ...
                        <form action="{{ route('member.order.update', [$order->id]) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="m-auto text-center">
                                    ...
                                    <div class="relative mt-0 md:mt-6">
                                        ...
                                        @else
                                            ...
                                            <label for="choose" class="px-4 py-2 text-left text-gray-700 rounded-xl bg-serv-hr">
                                                Choose File
                                            </label>
                                        @endif
                                    </div>
                            ...
                            <div class="">
                                <div class="p-1 mt-5">
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6">
                                            ...
                                            <textarea placeholder="Enter your biography here.." type="text" name="note" 
                                            id="note" autocomplete="note" class="block w-full py-3 mt-1 
                                            border-gray-300 rounded-md shadow-sm focus:ring-green-500 
                                            focus:border-green-500 sm:text-sm" rows="4" 
                                            {{ isset($order->file) ? 'disabled' : '' }}>{{ $order->note ?? '' }}</textarea>
                                        @if ($errors->has('note'))
                                ...
                                <div class="px-1 py-4 text-right">
                                    <a href="{{ route('member.order.index') }}" type="button" class="inline-flex justify-center 
                                    px-4 py-2 mr-4 text-sm font-medium text-gray-700 bg-white border border-gray-600 
                                    rounded-lg shadow-sm hover:bg-white focus:outline-none focus:ring-2 focus:ring-offset-2 
                                    focus:ring-gray-300" onclick="return confirm('Are you sure want to back ?, any changes you make will not be saved')">
                                        Back
                                    </a>

                                    @if (isset($order->file) == FALSE)
                                        <button type="submit" onclick="return confirm('Are you sure want to submit this data')"
