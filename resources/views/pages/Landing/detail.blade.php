                    ...
                    <div class="flex overflow-x-scroll hide-scroll-bar dragscroll">
                        ...
                        <div class="flex mt-2 flex-nowrap">
                            @forelse ($thumbnail as $item)
                                ...
                                src="{{ url(Storage::url($item->thumbnail)) }}" alt="thumbnail service" class="inline-block mr-2 rounded-lg cursor-pointer h-20 w-36 object-cover">
                            @empty
                                {{-- empty --}}
                            @endforelse
                        </div>
                                ...
                                <div class="flex items-center col-span-12 p-2 lg:col-span-6">
                                    ...
                                    <div class="flex items-center space-x-4">
                                        @if ($service->user->detail_user->photo != NULL)
                                            <img src="{{ url(Storage::url($service->user->detail_user->photo)) }}" alt="My profile" class="w-20 h-20 rounded-full object-cover" loading="lazy">
                                        @else
