<aside class="fixed inset-y-0 z-20 flex-shrink-0 w-64 overflow-y-auto bg-white md:hidden" 
x-show="isSideMenuOpen" x-transition:enter="transition ease-in-out duration-150" 
x-transition:enter-start="opacity-0 transform -translate-x-20" x-transition:enter-end="opacity-100" 
x-transition:leave="transition ease-in-out duration-150" x-transition:leave-start="opacity-100" 
x-transition:leave-end="opacity-0 transform -translate-x-20" @click.away="closeSideMenu" @keydown.escape="closeSideMenu" aria-label="aside">
    ...
    <div class="py-4 text-gray-500 dark:text-gray-400">
        ...
        <div class="flex items-center pt-5 pl-5 mt-10 space-x-2 border-t border-gray-100">
            ...
            @if (auth()->user()->detail_user()->first()->photo != NULL)
                ...
                class="object-cover object-center mr-1 rounded-full w-14 h-14" loading="lazy">
            @else
